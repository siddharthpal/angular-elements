...
var TodoWrapperModule = /** @class */ (function () {
    function TodoWrapperModule(injector) {
        this.injector = injector;
        var todoElement = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_3__["createCustomElement"])(_todo_todo_component__WEBPACK_IMPORTED_MODULE_4__["TodoComponent"], {
            injector: this.injector
        });
        customElements.define('todo-root-angular-element', todoElement);
    }
    TodoWrapperModule.prototype.ngDoBootstrap = function () { };
...
var TodoComponent = /** @class */ (function () {
    function TodoComponent(ngZone) {
        ...
        this.newTodo = '';
        this.todos = [];
        this.pushTodoItem = function (todo) {
            _this.ngZone.run(function () {
                _this.todos.push(todo);
            });
        };
        this.deleteTodoItem = function (todo) {
            _this.ngZone.run(function () {
                _this.todos = _this.todos.filter(function (t) { return t.title !== todo.title; });
            });
        };
    }
    ...
    TodoComponent.prototype.toggle = function () { };
    TodoComponent.prototype.delete = function (todo) {
        this.removeTodoEmitter.emit(todo);
        this.todos = this.todos.filter(function (t) { return t.title !== todo.title; });
    };
